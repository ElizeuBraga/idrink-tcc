        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr class="{{$d->status == 'canceled' ? 'text-danger' : ''}}">
                    ...
                    @if ($d->payment == 'money')
                    <td class="">
                        <i class="fas fa-money-bill-wave" style="color: green;" title="Dinheiro troco para {{number_format($d->change, 2)}}"></i> -
                            {{number_format($d->change, 2)}}
                    </td>
                    @elseif($d->payment == 'credit')
                    <td class="">
                        <i class="far fa-credit-card" style="color: orange;" title="Crédito"></i>
                    </td>
                    @else
                    <td class="">
                        <i class="far fa-credit-card" style="color: blue;" title="Débito"></i>
                    </td>
                    @endif
                    <td>
